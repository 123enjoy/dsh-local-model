...
const DEFAULTS = {
  ...
  //   the OLDEST messages are replaced (in the outbound copy only) by a
  //   local-model history summary; the most recent messages stay intact.
  pruneEnabled: true,
  pruneBudgetTokens: 40000,    // request messages above this estimate trigger pruning
  ...
  pruneRegenEvery: 6,          // regenerate the summary at most once per N newly-pruned messages
